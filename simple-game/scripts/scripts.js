...
var crashSound; // звук столкновения с астероидом
var menuMusic; // музыка меню
...
document.addEventListener("DOMContentLoaded", function() { // начинаем играть музыку меню, когда загрузится страница
    menuMusic.play();
});
...
function startGame() {
    ...
    menuMusic.stop(); // остановить музыку меню
    gameTheme.play();
